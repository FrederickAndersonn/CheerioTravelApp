  ...
  return (
    <Layout>
      <div className="flex"  style={{ maxHeight: '85vh', overflowY: 'auto' }}>
        ...
        <div className="w-1/3 p-4 border-r text-xs" style={{ maxHeight: '100vh', overflowY: 'auto' }}>
          ...
          <input
            ...
            onChange={(e) => setDestinationData({ ...destinationData, activities: e.target.value.split(', ') })}
            className="border p-2 mb-2 w-full"
          />
          <input
            type="text"
            ...
            onChange={(e) => setDestinationData({ ...destinationData, photos: e.target.value.split(', ') })}
            className="border p-2 mb-4 w-full"
          />
          <button className="bg-blue-500 text-white px-4 py-2 rounded" onClick={handleDestinationSubmit}>
            Create Destination
          </button>
          ...
          <input
            ...
            onChange={(e) => setTripData({ ...tripData, imageUrl: e.target.value })}
            className="border p-2 mb-2 w-full"
          />
          <input
            type="date"
          ...
          <input
            ...
            onChange={(e) => setTripData({ ...tripData, participants: e.target.value.split(', ') })}
            className="border p-2 mb-2 w-full"
          />
          <input
            type="text"
            ...
            onChange={(e) => setTripData({ ...tripData, destinations: e.target.value.split(', ') })}
            className="border p-2 mb-4 w-full"
           />
          <button className="bg-blue-500 text-white px-4 py-2 rounded" onClick={handleTripSubmit}>
                Create Trip
          </button>
        ...
        <input
            ...
            className="border p-2 mb-4 w-full"
        />
        <button className="bg-blue-500 text-white px-4 py-2 rounded" onClick={handleUpdateDestination}>
            Update Destination
        </button>
        ...
        <input
            ...
            className="border p-2 mb-4 w-full"
        />
        <button className="bg-blue-500 text-white px-4 py-2 rounded" onClick={handleUpdateTrip}>
            Update Trip
        </button>
    </div>
        ...
        <div className="w-1/3 p-4 border-r" style={{ maxHeight: '100vh', overflowY: 'auto' }}>
          ...
          />
          {trips.map((trip) => (
            <div key={trip._id} className="mb-4 text-xs border-2 p-2 rounded overflow-auto">
                ...
                <div className="flex mt-2">
                    ...
                    />
                    <button className="bg-green-500 text-[8px] text-white p-1 rounded" onClick={() => handleAddDestinationToTrip(trip._id)}>
                        Add Destination
                    </button>
                    <button className="bg-red-500 text-[8px] text-white p-1 rounded" onClick={() => handleRemoveDestinationFromTrip(trip._id)}>
                        Delete Destination
                    </button>
                    <button className=" text-white p-1 rounded mr-2" onClick={() => handleDeleteTrip(trip._id)}>
        ...
        {/* Right Section */}
        <div className="w-1/3 p-4 text-xs" style={{ maxHeight: '100vh', overflowY: 'auto' }}>
            ...
            {destinations.map((destination) => (
                <div key={destination._id} className="mb-4 border-2 p-2 relative rounded overflow-auto">
                    ...
                    <button className=" text-white px-2 py-2 rounded mt-2 absolute bottom-1 right-1" onClick={() => handleDeleteDestination(destination._id)}>
                        <img src={deleteIcon} alt="delete" className="w-6 " />
                    </button>
                </div>
            ))}
